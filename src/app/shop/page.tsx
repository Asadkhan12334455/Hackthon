...
const ShopPage = () => {
    return (
        ...
        />
            ...
            <Link href={"/asgaard"}><div className='w-[60px] h-[60px] bg-[#B88E2F] text-white flex items-center justify-center'>1</div></Link>
            <Link href={"/asgaard"}><div className='w-[60px] h-[60px] bg-[#F9F1E7] hover:bg-[#B88E2F] hover:text-[White] flex items-center justify-center'>2</div></Link> 
            <Link href={"/asgaard"}><div className='w-[60px] h-[60px] bg-[#F9F1E7] hover:bg-[#B88E2F] hover:text-[White] flex items-center justify-center'>3</div></Link>
            <Link href={"/asgaard"}><div className='w-[60px] h-[60px] bg-[#F9F1E7] hover:bg-[#B88E2F] hover:text-[White] flex items-center justify-center'>Next</div></Link>
            </div>
            <Feature />
        </>
    )
